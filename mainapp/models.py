...
class RescueCamp(models.Model):
    ...
    food_req = models.TextField(blank=True,null=True,verbose_name="Food Description- ഭക്ഷണം")
    food_required_number = models.TextField(blank=True,null=True,verbose_name="Food required- ഭക്ഷണം ആവിശ്യമുള്ളത്   ")
    food_recieved_number = models.TextField(blank=True,null=True,verbose_name="Food recieved- ഭക്ഷണം ലഭിച്ചവ ")
    clothing_req = models.TextField(blank=True,null=True,verbose_name="Clothing Description- വസ്ത്രം")
    clothing_required_number = models.TextField(blank=True,null=True,verbose_name="clothing required- വസ്ത്രം ആവിശ്യമുള്ളത് ")
    clothing_recieved_number = models.TextField(blank=True,null=True,verbose_name="clothing recieved- വസ്ത്രം ലഭിച്ചവ ")
    sanitary_req = models.TextField(blank=True,null=True,verbose_name="Sanitary Description- സാനിറ്ററി")
    sanitary_required_number = models.TextField(blank=True,null=True,verbose_name="sanitary required- സാനിറ്ററി ആവിശ്യമുള്ളത് ")
    sanitary_recieved_number = models.TextField(blank=True,null=True,verbose_name="sanitary recieved- സാനിറ്ററി ലഭിച്ചവ")
